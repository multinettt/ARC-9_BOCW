...
SWEP.Description = [[Full-auto submachine gun. Underwater Rifle modified for improved land performance. Fire 5.66mm steel darts with moderate bullet velocity.

The APS Underwater Rifle is a weapon appearing as an assault rifle in Call of Duty: Ghosts and a submachine gun in Call of Duty: Black Ops Cold War.

The APS Underwater Rifle returns in Call of Duty: Black Ops Cold War as the UGR now under in the submachine guns class. It was added on May 6th, 2022 update.]]
...
SWEP.ArmorPiercing = 0.32 -- Between 0-1. A proportion of damage that is done as direct damage, ignoring protection.
...
SWEP.ShootSound = "ARC9_BOCW.ugr_fire"                            -- Fire
...
SWEP.DistantShootSound = "ARC9_BOCW.ugr_fire_dist"                     -- Distant fire
