ATT.PrintName = "Tiger Team Spotlight Compact"
ATT.CompactName = "TGR TEAM"
ATT.Icon = Material("entities/bocw_atts/bodies/smg_flashlightpro_east.png", "mips smooth")
...
ATT.Category = {"bocw_body_flashlightsmg_east"}
