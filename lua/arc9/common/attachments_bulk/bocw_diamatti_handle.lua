...
ATT.Icon = Material("entities/bocw_atts/handles/diamatti_speedtape.png", "mips smooth")
...
ATT.Category = "bocw_diamatti_wrap"

ATT.Model = "models/weapons/arc9/atts/bocw_diamatti_handle_speedtape.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_diamatti_handle_speedtape")

ATT = {}

ATT.PrintName = "Dropshot Wrap" --// 2
ATT.CompactName = "DRPSHT WRP"
ATT.Icon = Material("entities/bocw_atts/handles/diamatti_dropshot.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_diamatti_handle_dropshot.mdl"

ATT.Scale = 1
ATT.ModelOffset = Vector(0, 0, 0)
ATT.ModelAngleOffset = Angle(0, 0, 0)

ARC9.LoadAttachment(ATT, "bocw_diamatti_handle_dropshot")

ATT = {}

ATT.PrintName = "Field Tape" --// 3
ATT.CompactName = "FILD TPE"
ATT.Icon = Material("entities/bocw_atts/handles/diamatti_fieldtape.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_diamatti_handle_fieldtape.mdl"

ATT.Scale = 1
ATT.ModelOffset = Vector(0, 0, 0)
ATT.ModelAngleOffset = Angle(0, 0, 0)

ARC9.LoadAttachment(ATT, "bocw_diamatti_handle_fieldtape")

ATT = {}

ATT.PrintName = "SASR Jungle Grip" --// 4
ATT.CompactName = "SASR GRP"
ATT.Icon = Material("entities/bocw_atts/handles/diamatti_sasrjungle.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_diamatti_handle_sasrjungle.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_diamatti_handle_sasrjungle")

ATT = {}

ATT.PrintName = "Serpent Wrap" --// 5
ATT.CompactName = "SRPNT WRP"
ATT.Icon = Material("entities/bocw_atts/handles/diamatti_serpent.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_diamatti_handle_serpent.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_diamatti_handle_serpentgrip")

ATT = {}

ATT.PrintName = "Airborne Elastic Wrap" --// 6
ATT.CompactName = "AIRBRN WRP"
ATT.Icon = Material("entities/bocw_atts/handles/diamatti_airborne.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_diamatti_handle_airborne.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_diamatti_handle_airbornewrap")