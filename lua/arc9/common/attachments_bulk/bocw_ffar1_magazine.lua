local ATT = {} --38Rnd:5 Jngl:32 40RndSpd:57 50Rnd:84 BO:112 Salvo:140

ATT = {}

ATT.PrintName = "38 Rnd" --// 1
ATT.CompactName = "38 RND"
ATT.Icon = Material("entities/bocw_atts/magazines/ffar1_ext1.png", "mips smooth")
ATT.Description = [[Extended magazine holds 38 rounds of ammunition.
...
ATT.Category = "bocw_ffar1_mag"

ATT.Model = "models/weapons/arc9/atts/bocw_ffar1_magazine_ext1.mdl"

ATT.Scale = 1
ATT.ModelOffset = Vector(0, 0, 0)
ATT.ModelAngleOffset = Angle(0, 0, 0)

ATT.ClipSizeOverride = 38

ATT.ReloadTimeMult = 1.05

ATT.ActivateElements = {"ffar1_mag_ext", "maggone"}

ARC9.LoadAttachment(ATT, "bocw_ffar1_magazine_ext1")

ATT = {}

ATT.PrintName = "Jungle-Style Mag" --// 2
ATT.CompactName = "JNGL MAG"
ATT.Icon = Material("entities/bocw_atts/magazines/ffar1_dual1.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_ffar1_magazine_dual1.mdl"
...
ATT.ActivateElements = {"ffar1_mag_dual"}

ARC9.LoadAttachment(ATT, "bocw_ffar1_magazine_dual")

ATT = {}

ATT.PrintName = "25 Rnd Speed Mag" --// 3
ATT.CompactName = "25 RND SPD"
ATT.Icon = Material("entities/bocw_atts/magazines/ffar1_mix1.png", "mips smooth")
ATT.Description = [[Lightweight magazine contains 25 rounds and improves reload speed.
...
ATT.Model = "models/weapons/arc9/atts/bocw_ffar1_magazine_mix1.mdl"
...
ATT.ActivateElements = {"ffar1_mag_mix", "maggone"}

ARC9.LoadAttachment(ATT, "bocw_ffar1_magazine_mix1")

ATT = {}

ATT.PrintName = "STANAG 44 Rnd" --// 4
ATT.CompactName = "44 RND"
ATT.Icon = Material("entities/bocw_atts/magazines/ffar1_extpro.png", "mips smooth")
ATT.Description = [[High-capacity drum magazine holds 44 rounds of ammunition.
...
ATT.Model = "models/weapons/arc9/atts/bocw_ffar1_magazine_extpro.mdl"

ATT.Scale = 1
ATT.ModelOffset = Vector(0, 0, 0)
ATT.ModelAngleOffset = Angle(0, 0, 0)

ATT.ClipSizeOverride = 44
...
ARC9.LoadAttachment(ATT, "bocw_ffar1_magazine_extpro")

ATT = {}

ATT.PrintName = "SAS Mag Clamp" --// 5
ATT.CompactName = "SAS CLMP"
ATT.Icon = Material("entities/bocw_atts/magazines/ffar1_dualpro.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_ffar1_magazine_dualpro.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_ffar1_magazine_dualpro")

ATT = {}

ATT.PrintName = "Salvo 25 Rnd Fast Mag" --// 6
ATT.CompactName = "25 RND FAST"
ATT.Icon = Material("entities/bocw_atts/magazines/ffar1_mixpro.png", "mips smooth")
ATT.Description = [[Lightweight extended magazine improves reload speed. Contains 25 rounds.
...
ATT.Model = "models/weapons/arc9/atts/bocw_ffar1_magazine_mixpro.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_ffar1_magazine_mixpro")