...
ATT.Icon = Material("entities/bocw_atts/handles/ak47_speedtape.png", "mips smooth")
...
ATT.Category = "bocw_ak47_wrap"

ATT.Model = "models/weapons/arc9/atts/bocw_ak47_handle_speedtape.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_ak47_handle_speedtape")

ATT = {}

ATT.PrintName = "Dropshot Wrap" --// 2
ATT.CompactName = "DRPSHT WRP"
ATT.Icon = Material("entities/bocw_atts/handles/ak47_dropshot.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_ak47_handle_dropshot.mdl"

ATT.Scale = 1
ATT.ModelOffset = Vector(0, 0, 0)
ATT.ModelAngleOffset = Angle(0, 0, 0)

ARC9.LoadAttachment(ATT, "bocw_ak47_handle_dropshot")

ATT = {}

ATT.PrintName = "Field Tape" --// 3
ATT.CompactName = "FILD TPE"
ATT.Icon = Material("entities/bocw_atts/handles/ak47_fieldtape.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_ak47_handle_fieldtape.mdl"

ATT.Scale = 1
ATT.ModelOffset = Vector(0, 0, 0)
ATT.ModelAngleOffset = Angle(0, 0, 0)

ARC9.LoadAttachment(ATT, "bocw_ak47_handle_fieldtape")

ATT = {}

ATT.PrintName = "Spetsnaz Field Grip" --// 4
ATT.CompactName = "SPTZ GRP"
ATT.Icon = Material("entities/bocw_atts/handles/ak47_spetsnaz.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_ak47_handle_spetsnaz.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_ak47_handle_sasrjungle")

ATT = {}

ATT.PrintName = "Serpent Wrap" --// 5
ATT.CompactName = "SRPNT WRP"
ATT.Icon = Material("entities/bocw_atts/handles/ak47_serpent.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_ak47_handle_serpent.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_ak47_handle_serpentwrap")

ATT = {}

ATT.PrintName = "GRU Elastic Wrap" --// 6
ATT.CompactName = "GRU WRP"
ATT.Icon = Material("entities/bocw_atts/handles/ak47_gruelastic.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_ak47_handle_gru.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_ak47_handle_gruelasticwrap")